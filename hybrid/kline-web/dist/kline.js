...
function () {
  ...
  _createClass(ChartManager, [{
    ...
    key: "changeWithPixelRatio",
    value: function changeWithPixelRatio(context) {
    ...
    value: function bindCanvas(layer, canvas) {
      if (layer === "main") {
        ...
        if (this._captureMouseWheelDirectly) {
					...
					hammertime.on("pinchin", __WEBPACK_IMPORTED_MODULE_0__control__["a" /* Control */].pinchin);
					hammertime.on("pinchout", __WEBPACK_IMPORTED_MODULE_0__control__["a" /* Control */].pinchout);
    ...
    value: function layout(context, frameName, left, top, right, bottom) {
      ...
      frame.layout(left-100, top, right, bottom);
...
function () {
  ...
  _createClass(Kline, [{
    ...
    value: function draw() {
      ...
      Kline.refreshFunction_inteval = setInterval(__WEBPACK_IMPORTED_MODULE_0__control__["a" /* Control */].refreshFunction, this.intervalTime);
      ...
      if (Kline.instance.hideSizeIcon) {
        __WEBPACK_IMPORTED_MODULE_7_jquery___default()('.chart_container.light #chart_updated_time').css('display', 'none');
      }
    }
  }, {
    key: "destroy",
    value: function destroy() {
      ...
      window.clearInterval(__WEBPACK_IMPORTED_MODULE_0__control__["a" /* Control */].refreshHandler);
      window.clearTimeout(Kline.instance.timer);
      __WEBPACK_IMPORTED_MODULE_0__control__["a" /* Control */].AbortRequest();
      this.disconnect();
      __WEBPACK_IMPORTED_MODULE_7_jquery___default()(this.element).empty();
      console.log('destroy');
      this.symbol = '';
      this.symbolName = '';
    } // updated (params) {
    ...
    key: "setSymbol",
    value: function setSymbol(symbol, symbolName, params) {
      this.symbol = symbol;
    ...
    key: "change",
    value: function change(range) {}
  }, {
    key: "updateCurrentPeriod",
    value: function updateCurrentPeriod(range) {}
  }, {
      ...
      __WEBPACK_IMPORTED_MODULE_7_jquery___default()(document).ready(function () {
        ...
        __WEBPACK_IMPORTED_MODULE_7_jquery___default()("#clearCanvas").click(function () {
          ...
          __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.redraw('OverlayCanvas', false);
				...
				window.isDown = false;
        __WEBPACK_IMPORTED_MODULE_7_jquery___default()("#chart_overlayCanvas").on("touchmove", function (e) {
          var r = e.target.getBoundingClientRect();
          var x = (e.touches[0].clientX - r.left) * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio();
          var y = (e.touches[0].clientY - r.top) * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio();
          var mgr = __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance;
          
					if(!isDown){
						__WEBPACK_IMPORTED_MODULE_2__chart_manager__["a"].instance.onMouseDown("frame0", x, y);
...
Kline.created = false;
Kline.instance = null;
Kline.refreshFunction_inteval = null;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__kline__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__kline__ = __webpack_require__(2);
  ...
  _createClass(ChartSettings, null, [{
    ...
    value: function init() {
      ...
      for (var i = 0; i < _name.length; i++) {
        var _value = __WEBPACK_IMPORTED_MODULE_1__chart_manager__["a" /* ChartManager */].instance.createIndicatorAndRange('', _name[i], true);
    ...
    key: "load",
    value: function load() {
      if (!__WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.readCookie) {
        return;
      }
...
function (_Theme) {
  ...
  function DarkTheme() {
    ...
    _this._fonts = [];
    _this._fonts[Theme.Font.Default] = Theme.Font.Size * __WEBPACK_IMPORTED_MODULE_1__chart_manager__["a" /* ChartManager */].instance.getPixelRatio() + "px Tahoma";
    return _this;
  }
...
function (_Theme2) {
  ...
  function LightTheme() {
    ...
    _this2._fonts = [];
    _this2._fonts[Theme.Font.Default] = Theme.Font.Size * __WEBPACK_IMPORTED_MODULE_1__chart_manager__["a" /* ChartManager */].instance.getPixelRatio() + "px Tahoma";
    return _this2;
  }
...
function () {
  ...
  _createClass(Template, null, [{
    ...
    value: function createMainChartComps(dsName) {
      ...
      range.setPaddingTop(28 * __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getPixelRatio());
      range.setPaddingBottom(12 * __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getPixelRatio());
...
function () {
  ...
  _createClass(TemplateMeasuringHandler, null, [{
    ...
    value: function onMeasuring(sender, args) {
      ...
      if (areaName === "timeline") {
        sender.setMeasuredDimension(width, 22 * __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getPixelRatio());
      }
    }
  }]);
  ...
  _createClass(Control, null, [{
    ...
    value: function requestOverHttp() {
      ...
      __WEBPACK_IMPORTED_MODULE_6_jquery___default()(document).ready(__WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.G_HTTP_REQUEST = __WEBPACK_IMPORTED_MODULE_6_jquery___default.a.ajax({
        type: __WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.method,
        url: __WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.url,
        dataType: 'json',
        data: __WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.params,
        timeout: 30000,
        created: Date.now(),
        ...
        success: function success(res) {
					var d = {"data": {"lines":[]},"success": true};
					d.data.lines = JSON.parse(res.data);
          if (__WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.G_HTTP_REQUEST) {
            res = __WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.filterData(d);
    ...
    value: function TwoSecondThread() {
      ...
      console.log(__WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.requestParam, f.toString(), 'TwoSecondThread');
      Control.requestData();
    ...
    value: function readCookie() {
      ...
      console.log('readcookie', __WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.init, __WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance); // let symbol = Kline.instance.setCookieSymbol()
    ...
    value: function onSize(w, h) {
      ...
      __WEBPACK_IMPORTED_MODULE_6_jquery___default()('#chart_mainCanvas,#chart_overlayCanvas').css({
        width: (canvasGroupRect.w) + 'px',
        height: canvasGroupRect.h + 'px'
      });
      ...
      mainCanvas.width = (canvasGroupRect.w) * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio();
      mainCanvas.height = canvasGroupRect.h * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio();
      overlayCanvas.width = (canvasGroupRect.w) * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio();
      overlayCanvas.height = canvasGroupRect.h * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio();
      if (tabBarShown) {
        tabBar.css({
    ...
    key: "pinchin",
    value: function pinchin() {
			//alert("pinchin");
      __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.scale(-1);
      __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.redraw("All", true);
      return false;
    }
  }, {
    key: "pinchout",
    value: function pinchout() {
			//alert("pinchout");
      __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.scale(1);
      __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.redraw("All", true);
      return false;
    ...
    value: function Draw(context) {
      ...
      for (var n in gradations) {
       ...
       /* gridRects.push({
          x: left,
          y: y,
          w: 6 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a"].instance.getPixelRatio(),
          h: 1 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a"].instance.getPixelRatio()
        });
        gridRects.push({
          x: right - 6 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a"].instance.getPixelRatio(),
          y: y,
          w: 6 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a"].instance.getPixelRatio(),
          h: 1 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a"].instance.getPixelRatio()
        }); */
...
function (_Plotter10) {
  ...
  _createClass(TimelineSelectionPlotter, [{
    ...
    value: function Draw(context) {
      ...
      context.fillRect(x - 52.5 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio(), area.getTop() + 2.5 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio(), 106 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio(), 18 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio());
      context.strokeStyle = theme.getColor(__WEBPACK_IMPORTED_MODULE_6__themes__["c" /* Theme */].Color.Grid3);
      context.strokeRect(x - 52.5 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio(), area.getTop() + 2.5 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio(), 106 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio(), 18 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio());
      context.font = theme.getFont(__WEBPACK_IMPORTED_MODULE_6__themes__["c" /* Theme */].Font.Default);
      context.textAlign = "center";
      context.textBaseline = "middle";
      context.fillStyle = theme.getColor(__WEBPACK_IMPORTED_MODULE_6__themes__["c" /* Theme */].Color.Text4);
  ...
  _createClass(RangeSelectionPlotter, [{
    ...
    value: function Draw(context) {
      ...
      Plotter.createPolygon(context, [{
        ...
        "x": area.getLeft() + 5 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio(),
        "y": y + 10 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio()
      }, {
        "x": area.getRight() - 3 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio(),
        "y": y + 10 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio()
      }, {
        "x": area.getRight() - 3 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio(),
        "y": y - 10 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio()
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__js_kline__ = __webpack_require__(2);
...
function () {
  ...
  _createClass(Chart, [{
    ...
    value: function updateDataAndDisplay() {
      ...
      __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.change(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.range);
    }
  }, {
    ...
    value: function setCurrentPeriod(period) {
      ...
      __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.updateCurrentPeriod(this._range, __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.params);
      this.updateDataAndDisplay();
...
function (_NamedObject) {
  ...
  _createClass(Timeline, [{
    ...
    value: function getItemWidth() {
      return Timeline.itemWidth[this._scale] * __WEBPACK_IMPORTED_MODULE_1__chart_manager__["a" /* ChartManager */].instance.getPixelRatio();
    }
  }, {
    key: "getSpaceWidth",
    value: function getSpaceWidth() {
      return Timeline.spaceWidth[this._scale] * __WEBPACK_IMPORTED_MODULE_1__chart_manager__["a" /* ChartManager */].instance.getPixelRatio();
    }
  }, {
    key: "getColumnWidth",
    ...
    value: function onLayout() {
      ...
      if (area !== null) {
        this._innerLeft = area.getLeft() + Timeline.PADDING_LEFT * __WEBPACK_IMPORTED_MODULE_1__chart_manager__["a" /* ChartManager */].instance.getPixelRatio();
        var w = Math.max(0, area.getWidth() - (Timeline.PADDING_LEFT + Timeline.PADDING_RIGHT) * __WEBPACK_IMPORTED_MODULE_1__chart_manager__["a" /* ChartManager */].instance.getPixelRatio());
...
function (_areas$ChartAreaGroup) {
  ...
  _createClass(TableLayout, [{
    ...
    value: function measure(context, width, height) {
      ...
      var minRW = 76;
      var maxRW = Math.min(100, width >> 2);
      var rw = minRW;
      var mgr = __WEBPACK_IMPORTED_MODULE_1__chart_manager__["a" /* ChartManager */].instance;
      var timeline = mgr.getTimeline(this.getDataSourceName());
