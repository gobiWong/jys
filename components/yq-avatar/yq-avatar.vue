		...
		<view class="oper-wrapper" :style="{display: styleDisplay}">
			<view class="oper">
				<view class="btn-wrapper" v-if="showOper">
					...
					<view @click="fUpload"  hover-class="hover" :style="{width: btnWidth}"><text>完成</text></view>
				</view>
				<view class="clr-wrapper" v-else>
					...
					<view @click="fPrvUpload"  hover-class="hover" :style="{width: btnWidth}"><text>完成</text></view>
				</view>
			</view>
		</view>
	</view>
